...
class Vendor(Base):
    ...
    registration_checked_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    default_department_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("departments.id"))
